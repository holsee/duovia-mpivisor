...
namespace DuoVia.Net.TcpIp
{
    public class TcpHost : IDisposable
    {
        ...
        /// <summary>
        /// Constructs an instance of the host and starts listening for incoming connections on the first IPv4 IP found.
        ...
        public TcpHost(Type remotedType, int port)
            : this(Activator.CreateInstance(remotedType), port)
        {
        }

        /// <summary>
        /// Constructs an intance of the host and starts listening on the endpoint.
        /// All listener threads are regular background threads.
        /// 
        /// NOTE: the instance created from the specified type is not automatically thread safe!
        /// </summary>
        /// <param name="remotedType"></param>
        /// <param name="endpoint"></param>
        public TcpHost(Type remotedType, IPEndPoint endpoint)
            : this(Activator.CreateInstance(remotedType), endpoint)
        {
        }

        /// <summary>
        /// Constructs an instance of the host and starts listening for incoming connections on first IPv4 address found.
        /// All listener threads are regular background threads.
        /// 
        ...
        /// <param name="port">The port number for incoming requests</param>
        public TcpHost(object singletonInstance, int port)
        {
            ...
            Initialize(singletonInstance, new IPEndPoint(address, port));
        }
        ...
        /// <param name="endpoint"></param>
        public TcpHost(object singletonInstance, IPEndPoint endpoint)
        {
            Initialize(singletonInstance, endpoint);
        }

        private void Initialize(object singletonInstance, IPEndPoint endpoint)
        {
            _endPoint = endpoint;
